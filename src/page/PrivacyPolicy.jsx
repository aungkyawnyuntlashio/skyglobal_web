        ...
        <div className='h-screen w-screen mt-20'>
            <div className="py-6 bg-gray-100 text-gray-800">
                <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
                    <h1 className="text-2xl font-bold mt-4 mb-6 text-blue-600">
                    Privacy Policy
                    </h1>
                    ...
                    <li>
                        <strong>Application:</strong> Refers to Sky Global Multi Service,
                        the software program provided by the Company.
                    </li>
                    <li>
                        <strong>Company:</strong> Refers to Sky Global Multi Service, also
                        referred to as "We", "Us", or "Our".
                    </li>
                    <li>
                        <strong>Country:</strong> Myanmar (Burma)
                    </li>
                    <li>
                    ...
                    {/* Continue the same structure for the remaining sections */}
                    ...
                    <h3 className='text-lg font-medium mt-4 text-primary'>
                    ...
                    <p className="mt-14 mb-5 text-primary text-xl font-semibold">
                    ...
                    <h2 className="text-xl font-bold mt-14 text-blue-600">
