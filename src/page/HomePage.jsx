...
const HomePage = () => {
   return (
      ...
      <div className='h-[70%] md:h-[55%] w-screen '>
         <div class="relative bg-gradient-animation to-indigo-500 h-[110%] overflow-clip">
            {/* <!-- Wave Shape --> */}
            <div class="absolute bottom-0 left-0 right-0">
               <svg
                  class="w-full xl:h-[70vh]"
               ...
               <div className='w-full h-[4px] bg-white absolute bottom-0'>
            ...
            <div className='absolute inset-0 flex items-center justify-center flex-col md:flex-row mx-auto'>
               ...
               <div className='w-full md:w-[35%]  flex justify-center  items-center'>
                  <div className='flex text-txtColor mt-12 md:mt-2 justify-center'>
                     <img className='w-[36%] md:w-[35%] h-[80%] rounded-lg shadow-xl   z-10' src={bb} alt=""
                        style={{
                           boxShadow: '0px 0px 20px rgba(0,0,0,0.4)'
                        }}

                     />
                     <img className='w-[36%] md:w-[35%] h-[80%] rounded-lg shadow-xl -ml-12 rotate-12' src={aa} alt=""
                        style={{
                           boxShadow: '0px 0px 20px rgba(0,0,0,0.4)'
                        }}
                     />
         ...
         <div className='flex flex-col justify-center items-center mt-24 '>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 grid-cols-1 w-[90%] mx-auto p-10 place-items-center'>
               <div className='bg-slate-100 rounded-md w-64 h-52 mt-10 mx-2 relative'>
               ...
               <div className=' border-slate-200 bg-slate-50 rounded-md w-64 h-52 mt-10 mx-2 relative'>
                  <div className='flex flex-col px-6 py-4'>
                     <img
                        src={Staff}
                        className='w-8 mt-2 mb-2'
